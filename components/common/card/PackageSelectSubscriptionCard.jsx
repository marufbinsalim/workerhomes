...
const PackageSelectSubscriptionCard = ({
  item,
  className,
  value,
  onChange,
  ...
  return (
    <div
      className={`tw:relative font-primary tw:flex tw:flex-col tw:md:w-[288px] ${
        isPlatinum ? "tw:md:mt-[-46px] tw:h-[591px]" : "tw:h-[545px]"
      } tw:p-6 ${
        isPlatinum
    ...
    >
      ...
      <h3 className="tw:text-[24px] tw:font-semibold tw:text-[var(--color-primary)] tw:text-left tw:mb-4">
        {title}
      </h3>
      ...
      <div className="tw:flex-1">
        <h4 className="tw:font-semibold tw:text-[16px] tw:mb-3 tw:text-left tw:text-[var(--color-font-dark)]">
          {t("coreFeature")}
        </h4>
        <ul className="tw:space-y-3 tw:text-sm">
          ...
          <li className="tw:flex tw:items-start tw:gap-2">
            ...
            <span className="tw:font-medium tw:text-[14px] tw:text-[#5C5D76]">
              {item?.pics} {t("features.list.picture")}
            </span>
          </li>
...
export default PackageSelectSubscriptionCard;
