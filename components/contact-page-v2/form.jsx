export default function ContactForm() {
  return (
    <div className="font-primary tw:flex tw:flex-col tw:gap-5">
      ...
      <button className="tw:w-max tw:bg-blue-600  tw:py-2 tw:px-4  hover:tw:bg-blue-700 focus:tw:outline-none focus:tw:ring-2 focus:tw:ring-blue-500 focus:tw:ring-offset-2">
        Send to a message
      </button>
    </div>
  );
