...
import DwellingCategoryForm from '@/components/form/dwelling/category'
import useFetch from '@/hooks/useFetch'
import { remove } from '@/lib/services/dwelling/category'
import { useTranslations } from 'next-intl'
import { useState } from 'react'

const DwellingCategoryPage = ({ locale }) => {
  ...
  return (
    <>
      ...
      <Modal
        ...
        title={
          selected?.id && open.translate
            ? 'Translate Dwelling Category'
            : selected?.id && !open.translate
            ? 'Edit Dwelling Category'
            : 'Create New Dwelling Category'
        }
      >
        <DwellingCategoryForm
      ...
      <ConfirmModal
        title='Delete Dwelling Category'
...
export default DwellingCategoryPage
