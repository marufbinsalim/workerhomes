  ...
  const columns = [
    {
      ...
      Cell: (item) => (
        <div className="tw:flex tw:items-center tw:gap-3">
          <div className="tw:relative tw:w-[100px] tw:h-[100px] tw:p-[5px] tw:border-2 tw:border-solid tw:border-gray-200 tw:rounded-md">
            <Image
              src={exactPath(
    ...
    },
    {
      ...
      Cell: (item) => {
        ...
        if (item?.status === "AVAILABLE") {
          statusClass =
            "tw:bg-[var(--color-green-light)]  tw:font-normal tw:text-[var(--color-green)]";
    ...
    },
    {
      ...
      Cell: (item) => (
        <span className="tw:text-[var(--color-font-dark)] tw:font-normal tw:text-[14px] ">
          {formatDate(item?.createdAt, false, locale)}
        </span>
      ),
    },
    {
      ...
      Cell: (item) => (
        <div className="tw:flex tw:items-center tw:justify-end tw:gap-4">
          ...
          <div className="tw:relative tw:group">
            <Link
              href={`/${locale}/dashboard/dwellings/form/${item?.id}?step=1`}
            >
          ...
          <div className="tw:relative tw:group">
            <DropdownMenu
              trigger={
                <BsThreeDots
                  size={24}
                  className="tw:text-[var(--color-font-dark)] "
                />
              }
              options={[
                {
    ...
    <>
      <div className="">
        ...
        <Modal
          ...
          title={
            selected?.id ? t("modal.update.title") : t("modal.create.title")
          }
        >
          <DwellingFormStep
            formState={formState}
