  ...
  return (
    <>
      ...
      >
        ...
        {/* Desktop Navigation */}
        <div className="tw:hidden tw:md:flex tw:text-[var(--color-font-dark)] tw:font-normal tw:items-center tw:gap-6 tw:text-[14px] tw:mt-3">
          <a
            href="#"
        ...
        <div className="tw:hidden tw:md:flex tw:items-center tw:gap-4 tw:mt-3">
        ...
        {/* Mobile Menu Button */}
        <button
          className="tw:md:hidden tw:p-2 tw:text-gray-700 tw:mt-3"
          onClick={toggleMenu}
                ...
                <div className="tw:flex tw:items-center tw:justify-between tw:gap-2 tw:cursor-pointer">
                  ...
                  <div className="tw:flex tw:items-center tw:gap-2">
                    ...
                    <img
                      src="/assets/dropdown.png"
                      alt="icon"
                      className="tw:w-[13px] tw:h-[8px] tw:rounded-full"
                    />
                  </div>
                </div>
