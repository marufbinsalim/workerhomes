...
import { create, update, translate } from '@/lib/services/blog/category'
import {
  blogCategorySchema,
  initBlogCategory,
} from '@/lib/validation/blog/category'
...
const BlogCategoryForm = ({ formData, onSuccess, locale, translation }) => {
  ...
  return (
    <Formik
      initialValues={initBlogCategory(formData)}
